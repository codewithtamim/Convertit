...
enum class WaveEdge { Top, Bottom, Both }

/**
 * A [Shape] that clips its container with sine-wave top and/or bottom edges.
 * Used as a decorative backdrop for hero/feature sections.
 */
class SineWaveShape(
